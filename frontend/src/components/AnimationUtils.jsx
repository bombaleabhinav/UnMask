  ...
  useEffect(() => {
    ...
    const pulse = (timestamp) => {
      ...
      if (ref.current) {
        ...
        ref.current.style.boxShadow = `0 0 ${glow}px rgba(56, 189, 248, ${0.3 + Math.sin(elapsed * 2.5) * 0.2})`;
      }
...
export function AnimationStyles() {
  return (
    <style>{`
      ...
      .glow-btn:hover {
        box-shadow: 0 0 24px rgba(56, 189, 248, 0.25), 0 0 48px rgba(56, 189, 248, 0.1);
